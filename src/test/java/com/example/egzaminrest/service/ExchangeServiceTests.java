...
public class ExchangeServiceTests {
    ...
    public void shouldConvert() {
        ...
        double rate = 4.2;
        when(feignExchangeService.getFeignExchange(from,to).getRate(to));
    ...
    public void shouldGetExchange() {
        ...
        String to = "PLN";
        Double amount = 100.0;
        Double rateAmount = 4.2;
        Double amountAfterConvert = amount * rateAmount;
        ExchangeRequest exchangeRequest = new ExchangeRequest(from,to,amount);
//        when(exchangeService.convert(from,to,amount)).then(amountAfterConvert);
    }
